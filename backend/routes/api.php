...
use Illuminate\Support\Facades\Route; // ルート定義用のファサード
use App\Http\Controllers\AuthController; // 認証関連のAPIコントローラ
use App\Http\Controllers\EmployeesController; // 従業員管理のAPIコントローラ
use App\Http\Controllers\LeaveGrantMasterController; // 有給付与マスターのAPIコントローラ
use App\Http\Controllers\LeaveUsageController; // 有給取得履歴のAPIコントローラ
