...
const BASE_URL = "http://localhost:8000/api/leave-usages";
const ADD_URL = "http://localhost:8000/api/leave-usages/add";
const DELETE_URL = "http://localhost:8000/api/leave-usages/delete";
